...
def assert_state(desired_state):
    ...
    filtered_current_state = statelib.filtered_current_state(desired_state)
...
def _dict_update(origin_data, to_merge_data):
    """
    Recursively performs a dict update (merge), taking the to_mere_data and
    updating the origin_data.
    The function is mutable, changing the origin_data in-place.
    """
